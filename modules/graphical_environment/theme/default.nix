...
let
  cfg = config.system_settings.graphical_environment.theme;
in
{
  options.system_settings.graphical_environment.theme = {
    wallpaper = lib.mkOption { type = lib.types.path; default = ./assets/nix-wallpaper.png; };
